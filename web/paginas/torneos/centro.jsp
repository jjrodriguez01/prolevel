    ...
    <div class="row">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <sql:query var="equipos" dataSource="jdbc/pro-level">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>${row.nombre}</td>
                                <td><a href="editarjugadores.jsp?codigoEquipo=${row.codigo}&nombre=${row.nombre}"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></a></td>
                            </tr>
                            </c:forEach>
                        </tbody>
                    </table>
