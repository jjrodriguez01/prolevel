...
<script>
$(document).ready(function() {
    $("#formulario,#torneo,#cancha,#migadatos,#migatorneos,#migacanchas").hide();
    $("#datos").on("click",function(){
        $("#formulario").fadeIn("slow",function(){
            $("#torneo,#cancha,#migatorneos,#migacanchas").fadeOut();
            $("#migadatos").show(2000).addClass("active");
        });
    });
    $("#copas").on("click",function(){
    $("#torneo").fadeIn("slow",function(){
        $("#formulario,#cancha,#migadatos,#migacanchas").fadeOut("slow");
        $("#migatorneos").show(2000).addClass("active");
    });
    });
    $("#campos").on("click",function(){
        $("#cancha").fadeIn("slow",function(){
            $("#formulario,#torneo,#migadatos,#migatorneos").fadeOut("slow");
            $("#migacanchas").show(2000).addClass("active");
        });
    });
});
</script>
...
<div id="miga">
    <ol class="breadcrumb">
        ...
        <li class="" id="migadatos">Datos Personales</li>
        <li class="" id="migatorneos">Torneos</li>
        <li class="" id="migacanchas">Canchas</li>
    </ol>
</div>
...
<footer>
<p class="pie">2014 PRO-LEVEL - Todos los derechos reservados | Cambiar idioma <a href="#"><img src="imagenes/english.png" width="30" height="25" alt="idioma" /></a>Contáctanos<a href="#"><img src="imagenes/phone.png" width="40" height="40" alt="tel"/></a></p> 
