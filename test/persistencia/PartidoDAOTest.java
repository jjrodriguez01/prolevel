...
//    }
    ...
    /**
     * Test of listarTodoPronda method, of class PartidoDAO.
     */
    @Test
    public void testListarTodoPronda() throws Exception {
        System.out.println("listarTodoPronda");
        int idtorneo = 11;
        PartidoDAO instance = new PartidoDAO();
        List<PartidoDTO> expResult = null;
        List<PartidoDTO> result = instance.listarTodoPronda(idtorneo);
        assertEquals(expResult, result);
        // TODO review the generated test code and remove the default call to fail.
        fail("The test case is a prototype.");
    }
