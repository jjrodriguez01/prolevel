...
public class Reportes extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("tabla") !=null && request.getParameter("tabla").equals("posiciones")) {
            ...
            JasperReport reporte = (JasperReport) JRLoader.loadObjectFromFile(getServletContext().getRealPath("reportes/posiciones.jasper"));
            ...
            Connection conexion = Conexion.getInstance();
            //cargo el reporte en ruta dinamica
            File archivo = new File(getServletContext().getRealPath("reportes/posiciones.jasper"));
//            JasperReport reporte = (JasperReport) JRLoader.loadObject(getServletContext().getRealPath("reportes/goleadores.jasper"));
            @SuppressWarnings("unchecked")
